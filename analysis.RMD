...
# caption = 'ASV Count Table'
# kbl(table,align = "l", digits = 3, booktabs = TRUE, longtable = TRUE, format = "latex",
...
# caption = 'ASV Taxa Table'
# kbl(taxa,align = "l", digits = 3, booktabs = TRUE, longtable = TRUE, format = "latex",
#     escape = TRUE, caption = caption) %>%
#   kable_styling(
#     latex_options = c("striped", "hold_position","repeat_header",
#                       font_size = 16, pdf_font = "arial"))
...
caption = 'Lefse taxa from bronchoalveolar lavage and oral swab'
kbl(df,align = "l", digits = 3, booktabs = TRUE, longtable = FALSE, format = "latex",
    escape = TRUE, caption = caption) %>%
  kable_styling(
    latex_options = c("scale_down", font_size = 16, pdf_font = "arial"))
```
...
caption = 'Lefse Taxa from Bronchoalveolar Lavage'
kbl(df,align = "l", digits = 3, booktabs = TRUE, longtable = FALSE, format = "latex",
    escape = TRUE, caption = caption)%>%
  kable_styling(
    latex_options = c("scale_down", font_size = 16, pdf_font = "arial"))
...
caption = 'Lefse Taxa from oral swabs'
kbl(df,align = "l", digits = 3, booktabs = TRUE, longtable = FALSE, format = "latex",
    escape = TRUE, caption = caption)  %>%
  kable_styling(
    latex_options = c("scale_down", font_size = 16, pdf_font = "arial"))
...
kbl(kab,align = "l", digits = 4, booktabs = TRUE, longtable = FALSE, format = "latex",
    escape = TRUE, caption = caption) %>%
  kable_styling(
    latex_options = c("scale_down", font_size = 12, pdf_font = "arial"))
```
...
caption = 'Independent of H. pylori status'
kbl(df,align = "l", digits = 2, booktabs = TRUE, longtable = FALSE, format = "latex",
    escape = TRUE, caption = caption) %>%
  kable_styling(
    latex_options = c("scale_down", font_size = 16, pdf_font = "arial"))
# %>%
#   add_header_above(c("Lavage IL8 spearman" = 8), font_size = "larger", bold = T, align = "l")
```
...
kbl(df,align = "l", digits = 2, booktabs = TRUE, longtable = FALSE, format = "latex",
  ...
  kable_styling(
    latex_options = c("scale_down", font_size = 16, pdf_font = "arial"))
# %>%
#   add_header_above(c("Lavage Alpha Diversity" = 8), font_size = "larger", bold = T, align = "l")
```
...
kbl(df,align = "l", digits = 2, booktabs = TRUE, longtable = FALSE, format = "latex",
  ...
  kable_styling(
    latex_options = c("scale_down", font_size = 16, pdf_font = "arial"))
# %>%
#   add_header_above(c("Oral IL8 spearman" = 8), font_size = "larger", bold = T, align = "l")
```
...
kbl(df,align = "l", digits = 2, booktabs = TRUE, longtable = FALSE, format = "latex",
  ...
  kable_styling(
    latex_options = c("scale_down", font_size = 16, pdf_font = "arial"))
# %>%
#   add_header_above(c("Oral alpha diversity" = 8), font_size = "larger", bold = T, align = "l")
```
